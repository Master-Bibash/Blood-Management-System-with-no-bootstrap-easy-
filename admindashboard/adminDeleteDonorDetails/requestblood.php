...
<body>
    ...
    <div class="hero">
        <form method="post" action="process_request.php">
            <div class="heading"><h1>Request Blood Section</h1></div>
            ...
            <div class="row">
                <div class="input-group">
                    <input type="text" required id="Requested" name="Requested" value="<?php
                ...
                <div class="input-group">
                    <input type="text" required id="Contact" name="Contact">
            ...
            <div class="input-group">
                <textarea id="message" rows="8" name="user_message" required></textarea>
