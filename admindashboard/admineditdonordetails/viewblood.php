    ...
    border: 1px solid #ddd;">>
                         ...
                         <table class="customers">
                              <thead>
                                   <tr>
                                        ...
                                        <th>Available</th>
                                        <th><box-icon name='pencil'></box-icon></th>
                                   </tr>
                              </thead>
                              <tbody>
                                   <?php
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr class='gradeA'>
                ...
                <td>
                    <button>
                        <a href='/Final/admindashboard/admineditdonordetails/requestblood.php?id=" . $row['id'] . "' style='text-decoration: none; color: transparent;'><box-icon name='edit-alt'></box-icon></a>
                    </button>
                </td>
            </tr>";
        }
