...
<head>
     ...
     <link rel="stylesheet" href="EditSidebarstyle.css">
     <!-- Boxiocns CDN Link -->
...
">
                    ...
                    <form name="registrationForm" action="editannounce.php" method="post" onsubmit="return validateForm()">
                              ...
                              <?php
								...
								?> 
                                   ...
                                   <div class="input-field">
                                        ...
                                        <input type="text" name="announcement" type="text" name="bloodneed" value='<?php echo $row['bloodneed']; ?>' required>
                                        </div>
                                   <div class="input-field">
                                        <label>Blood Needed (Type)</label>
                                        <input type="text" type="text" name="bloodneed" value='<?php echo $row['bloodneed']; ?>' required>
                                   </div>

                                   <div class="input-field">
                                        <label>Date and Time</label>
                                        <input class="form-control" type="date" name="dat" type="date" value='<?php echo $row['dat']; ?>' required>
                                        </div>
                                   </div>

                                   <div class="input-field">
                                        <label>Organized by</label>
                                        <input placeholder="Enter Organizer's Name" type="text" name="organizer" value='<?php echo $row['organizer']; ?>' required>
                                   </div>
