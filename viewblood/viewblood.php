...
<head>
     <meta charset="UTF-8">
     <title> Blood Management Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt
          Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt
          Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt Systemt System</title>
...
?>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr class='gradeA'>
                ...
                <td>
                    <button>
                        <a href='/Final/viewblood/requestblood.php?id=" . $row['id'] . "' style='text-decoration: none; color: black;'>Request</a>
                    </button>
                </td>
            </tr>";
        }
